...
%manual work
magnetic_field = [row_means(2), (row_means(4)+row_means(5))/2, row_means(10), row_means(13), row_means(15)];
%substract the ground field
ground_field = (row_means(1)+row_means(8)+ row_means(11)+row_means(14))/4;
...
%from excel
fitting_curve_calculation = 0.0576*currents + 1e-12;
