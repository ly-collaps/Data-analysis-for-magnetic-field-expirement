...
% 
%manual work
ground_field = (row_means(1)+row_means(6)+ row_means(11))/3;
magnetic_field = [ground_field, row_means(2), (row_means(4)+row_means(5))/2, row_means(7),row_means(9),row_means(12)];
...
%from excel
fitting_curve_calculation = 74.5*currents;
...
% %manual work
% ground_field = (row_means(1)+row_means(6)+ row_means(11))/3;
% magnetic_field = [row_means(2), (row_means(4)+row_means(5))/2, row_means(7),row_means(9),row_means(12)];
% %substract the ground field
% magnetic_field = (magnetic_field - ground_field)*10^3; %conversion to nanoT
